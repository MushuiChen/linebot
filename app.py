...
def handle_message(event):
    ...
    if message == '天氣':
            ...
            original_content_url='https://youtu.be/Vk5-c_v4gMU?si=QQe0z7XjniwTTzup',  # 替換為實際的音樂檔案網址
            ...
            audio_message = AudioSendMessage(
            original_content_url='https://youtu.be/MZ8Ri-_Uusk?si=RCQEDdif3Q5ciZLY',  # 替換為實際的音樂檔案網址
